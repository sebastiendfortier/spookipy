...
class ArithmeticPercentageExceedingThresholdsByPoint(Plugin):
        ...
        for _, df_group in self.groups:
            ...
            for l, level_df in level_groups:
                ...
                for threshold in self.parsed_thresholds:
                    ...
                    all_ensemble_data_result = all_ensemble_data_result.astype("float32")
    ...
    def parse_config(args: str) -> dict:
        ...
        """
        parser = PluginParser(
            prog=ArithmeticPercentageExceedingThresholdsByPoint.__name__, parents=[Plugin.base_parser], add_help=False
        )
