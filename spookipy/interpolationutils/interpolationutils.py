...
def find_index_of_lat_lon_not_in_grid(input_grid: int, 
                                      grid_horizontal_dimension: float, 
                                      grid_vertical_dimension: float, 
                                      latitudes: np.ndarray, 
                                      longitudes: np.ndarray) -> List[int]:
    """
...
def do_extrapolation(interpolated_data: np.ndarray, 
                     data_before_interpolation: np.ndarray, 
                     indexes: Optional[List[int]],
                     extrapolation_type: str, 
                     extrapolation_value: float) -> np.ndarray:
    """
...
def scalar_interpolation(df: pd.DataFrame, 
...
def scalar_interp_with_extrapolation(out_grid: int, 
                                     in_grid: int, 
                                     data: np.ndarray, 
                                     indexes: Optional[List[int]], 
                                     extp_type: str, 
                                     extp_value: float) -> np.ndarray:
    """
...
def scalar_interpolation_parallel(df: pd.DataFrame, 
                                  results: List[pd.DataFrame], 
                                  input_grid: int, 
                                  output_grid: int, 
                                  extrapolation_type: str, 
...
def select_input_grid_source_data(vect_df: pd.DataFrame, 
                                  others_df: pd.DataFrame, 
                                  pt_df: pd.DataFrame) -> Tuple[pd.DataFrame, str]:
    """
...
def scalar_interp(out_grid: int, 
                  in_grid: int, 
...
def vectorial_interpolation(vect_df: pd.DataFrame, 
                            results: List[pd.DataFrame], 
                            input_grid: int, 
                            output_grid: int, 
                            extrapolation_type: str, 
...
def vectorial_interpolation_parallel(vect_df: pd.DataFrame, 
                                     results: List[pd.DataFrame], 
                                     input_grid: int, 
                                     output_grid: int, 
                                     extrapolation_type: str, 
...
def vect_interp_with_extrapolation(out_grid: np.ndarray, 
                                   in_grid: np.ndarray, 
                                   uu_data: np.ndarray, 
                                   vv_data: np.ndarray, 
                                   indexes: List[int], 
                                   extp_type: str, 
                                   extp_value: float) -> Tuple[np.ndarray, np.ndarray]:
