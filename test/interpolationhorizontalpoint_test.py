...
def simple_input_df():
    ...
    lat['d'] = np.expand_dims(
        np.array([45.73, 43.40, 49.18], dtype=np.float32), axis=-1)
    lat['ni'] = lat['d'].shape[0]
    lat['nj'] = lat['d'].shape[1]
    lon['d'] = np.expand_dims(
        np.array([-73.75, -79.38, -123.18], dtype=np.float32), axis=-1)
...
def latlon_extrapolation_df():
    lat, lon = base_dict()
    lat['d'] = np.expand_dims(np.array(
        [43.86, -43.4, 43.61, 43.47, 43.22, -44.0], dtype=np.float32), axis=-1)
    lat['ni'] = lat['d'].shape[0]
    lat['nj'] = lat['d'].shape[1]
    lon['d'] = np.expand_dims(np.array(
        [-78.926, 77.7, -78.380, -79.26, -78.72, 70.0], dtype=np.float32), axis=-1)
    lon['ni'] = lon['d'].shape[0]
    lon['nj'] = lon['d'].shape[1]
    latlon = [lat, lon]
...
def latlon_yy_df():
    lat, lon = base_dict()
    lat['d'] = np.expand_dims(np.array([46.60, 14.098, -
                                        45.828, -
                                        13.458, 51.048, -
                                        8.49, 56.056, -
                                        43.81, -
                                        ...
                                        80.11, -
                                        14.034, -
                                        15.68, 34.63, 36.22, 76.28], dtype=np.float32), axis=-
                              1)
    lat['ni'] = lat['d'].shape[0]
    lat['nj'] = lat['d'].shape[1]
    lon['d'] = np.expand_dims(np.array([-67.368, -44.74, -33.34, 38.155, 31.50, 116.93, 158.32, 170.64, -
                              52.73, -59.236, 100.28, 127.28, 40.56, -140.24, -30.495, -99.63], dtype=np.float32), axis=-1)
    lon['ni'] = lon['d'].shape[0]
    lon['nj'] = lon['d'].shape[1]
    latlon = [lat, lon]
...
def latlon2_df():
    lat, lon = base_dict()
    lat['d'] = np.expand_dims(
        np.array([45.73, 43.40, 49.18, 53.13], dtype=np.float32), axis=-1)
    lat['ni'] = lat['d'].shape[0]
    lat['nj'] = lat['d'].shape[1]
    lon['d'] = np.expand_dims(
        np.array([-73.75, -79.38, -123.18, -108.15], dtype=np.float32), axis=-1)
    lon['ni'] = lon['d'].shape[0]
    lon['nj'] = lon['d'].shape[1]
    latlon = [lat, lon]
