...
class TemperatureDewPoint(Plugin):
    ...
    def __init__(
        ...
        self.plugin_mandatory_dependencies_rpn = [
            ...
            {"TT": {"nomvar": "TT", "unit": "celsius"}, "ES": {"nomvar": "ES", "unit": "celsius", "select_only": True}},
        ]
        ...
        self.plugin_result_specifications = {"TD": {"nomvar": "TD", "label": "DEWPTT", "unit": "celsius"}}
    ...
    def prepare_groups(self):
        ...
        mandatory_temp_phase_switch_when_using_ice_water_phase_both(
            TemperatureDewPointError, self.explicit_params, self.ice_water_phase, self.rpn
        )
    ...
    def compute_vppr(self, dependencies_df):
        ...
        if vppr_df.empty:
            raise TemperatureDewPointError(
                "No results produced by TemperatureDewPoint, unable to calculate VapourPressure!"
            )
    ...
    def compute_es(self, dependencies_df):
        ...
        if es_df.empty:
            raise TemperatureDewPointError(
                "No results produced by TemperatureDewPoint, unable to calculate DewPointDepression!"
            )
