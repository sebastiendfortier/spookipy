...
class PrecipitationAmount(Plugin):
    ...
    @initializer
    def __init__(
        self, df: pd.DataFrame, nomvar=None, forecast_hour_range=None, interval=None, step=None, reduce_df=True
    ):
    ...
    def compute(self) -> pd.DataFrame:
        ...
        return self.final_results([df], PrecipitationAmountError, copy_input=False, reduce_df=self.reduce_df)
    ...
    def parse_config(args: str) -> dict:
        ...
        parser.add_argument(
            ...
            required=True,
            type=str,
            help="List of each time range used for the minimum/maximum calculation",
        )
        parser.add_argument(
            "--rangeForecastHour",
            required=True,
        ...
        apply_lambda_to_list(
            parsed_arg["nomvar"], lambda a: validate_nomvar(a, "PrecipitationAmount", PrecipitationAmountError)
        )
