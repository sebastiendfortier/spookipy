...
def wind_max(
    uu_3d: np.ndarray, vv_3d: np.ndarray, uv_3d: np.ndarray, px_3d: np.ndarray
...
class WindMax(Plugin):
    ...
    def __init__(self, df: pd.DataFrame):
        ...
        self.plugin_result_specifications = {
            ...
            "PX": {"nomvar": "PX", "label": "WNDMAX", "unit": "hPa", "ip1": 0},
        }
    ...
    def prepare_groups(self):
        ...
        self.groups = self.no_meta_df.groupby(["grid", "datev", "vctype"])
    ...
    def compute(self) -> pd.DataFrame:
        ...
        dependencies_list = get_dependencies(
            self.groups, self.meta_df, "WindMax", self.plugin_mandatory_dependencies, intersect_levels=True
        )
        ...
        for dependencies_df, _ in dependencies_list:
            ...
            uu_res_df.at[0, "d"], vv_res_df.at[0, "d"], uv_res_df.at[0, "d"], px_res_df.at[0, "d"] = wind_max(
                uu_3d, vv_3d, uv_3d, px_3d
            )
        ...
        return self.final_results(df_list, WindMaxError, copy_input=False)
