...
from ..utils import create_empty_result, existing_results, get_existing_result, get_intersecting_levels, initializer
...
class Helicity(Plugin):
    ...
    @initializer
    def __init__(self, df: pd.DataFrame, z3=0.851343, z4=0.297078, copy_input=False):
    ...
    def compute(self) -> pd.DataFrame:
        ...
        return self.final_results(df_list, HelicityError, copy_input=self.copy_input)
