...
`VerticalScan <classVerticalScan.html>`__
...
`Français <../../spooki_french_doc/html/pluginVerticalScan.html>`__
...
**Usage:**
    ...
    **Contacts:**
    ...
    Reference to `VerticalScan <classVerticalScan.html>`__
    :sup:``[code] <VerticalScan_8cpp_source.html>`__`

    Units tests

    `Evaluation tree <VerticalScan_graph.png>`__
