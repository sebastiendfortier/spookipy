...
class GeorgeKIndex(Plugin):
    ...
    def __init__(self, df: pd.DataFrame, copy_input=False, reduce_df=True):
        ...
        self.plugin_result_specifications = {
            "KI": {"nomvar": "KI", "label": "GEORKI", "unit": "1", "level": 0, "ip1_kind": 2}
        }
    ...
    def compute(self) -> pd.DataFrame:
        ...
        dependencies_list = get_dependencies(
            self.groups, self.meta_df, "GeorgeKIndex", self.plugin_mandatory_dependencies, {"ice_water_phase": "water"}
        )
        ...
        return self.final_results(df_list, GeorgeKIndexError, copy_input=self.copy_input, reduce_df=self.reduce_df)
