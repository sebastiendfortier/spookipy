...
def test_1(plugin_test_path, test_tmp_path, call_fstcomp):
    ...
    df      = spookipy.ArithmeticPercentileByPoint(src_df0, 
                                          [0,10,25,50,75,90,100]).compute()
...
def test_2(plugin_test_path, test_tmp_path, call_fstcomp):
    ...
    # plugin_test_path = Path('/home/ron000/site6/epsStat/in/eta/')
...
def test_4(plugin_test_path):
    ...
    with pytest.raises(spookipy.ArithmeticPercentileByPointError):
        _ = spookipy.ArithmeticPercentileByPoint(
            src_df0, [0,10,25,50,67.5,110]).compute()
...
def test_5(plugin_test_path):
    ...
    with pytest.raises(spookipy.ArithmeticPercentileByPointError):
        _ = spookipy.ArithmeticPercentileByPoint(
            src_df0, [0,-10,25,50,67.5,100]).compute()
